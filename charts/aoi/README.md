...
![Version: 0.1.11-rc1](https://img.shields.io/badge/Version-0.1.11--rc1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| https://victoriametrics.github.io/helm-charts/ | victoria-metrics-alert | 0.9.2 |
...
| victoria-metrics.persistentVolume.size | string | `"5Gi"` | Size of the volume. Should be calculated based on the metrics you send and retention policy you set. |
